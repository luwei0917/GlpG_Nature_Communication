...
public:
  ...
  double membrane_k_water;
  double water_gamma[5][20][20][2];
  double membrane_gamma[5][20][20][2];
  ...
  double k_helix, helix_gamma_p, helix_gamma_w, h4prob[20];
    double membrane_k_helix, membrane_h4prob[20];
  ...
  double helix_sigma_HO, helix_sigma_NO, helix_HO_zero, helix_NO_zero;
    double membrane_helix_sigma_HO, membrane_helix_sigma_NO, membrane_helix_HO_zero, membrane_helix_NO_zero;
  int helix_well_flag[5], n_helix_wells, helix_i_diff;
  int pro_accepter_flag;
    int membrane_pro_accepter_flag;
  double h4prob_pro_accepter;
    double membrane_h4prob_pro_accepter;
  ...
  bool ssweight_flag, dssp_hdrgn_flag, p_ap_flag, water_flag, membrane_gamma_flag, burial_flag, helix_flag, membrane_helix_flag, amh_go_flag, frag_mem_flag, ssb_flag;
  bool phosph_flag;
